var OccList = function (divid) {
	...
	function bindSearch () {	
		...
		tfield.
			data ([0])
			//.on ("click", function(d) { console.log ("click", tfield); filterNodes (); return false; })
	...
	this.update = function () {
		...
		console.log ("scrollTop, offset, scrollTop+clientHeight", thisDiv.scrollTop, offset, thisDiv.scrollTop + thisDiv.clientHeight);
