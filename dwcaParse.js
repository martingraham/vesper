VESPER.DWCAParser = new function () {
    ...
    this.loadxsd = function (xsdFile) {
        ...
        $.get(xsdFile, function(d){
            ...
            //    d = d.slice(2);
            //}
           // console.log ("yp22", d.charCodeAt(0), d.charCodeAt(1), d.charCodeAt(2), d);
            //console.log ("Native DOM Parse", NapVisLib.parseXML(d));
           // console.log ($.parseXML(d));
            console.log ("XSD", d, typeof d);
            VESPER.DWCAParser.xsd = (typeof d == "string" ? $(NapVisLib.parseXML(d)) : $(d));
           // console.log ("XSD", DWCAParser.xsd);
    ...
    this.makeRowTypeDefaults = function (xsdFile) {
        ...
        console.log ("rtd", VESPER.DWCAParser.rowTypeDefaults);
    };
    ...
    this.makeFieldAttrNames = function (xsdFile) {
        ...
        console.log ("fan", VESPER.DWCAParser.fieldAttrNames);
    };
	...
	this.taxaArray2JSONTree = function (tsvData, fileData, fieldIndexer) {
		...
		console.log ("JSON", jsonObj[1], jsonObj);
    ...
    this.taxaArray2ExplicitJSONTree = function (tsvData, fileData, fieldIndexer, addOriginalTo) {
        ...
        console.log ("SPECS", VESPER.DWCAParser.SPECS);
        ...
        ms = Date.now() - ms;
        console.log ("first iter pass: ",ms,"ms.");
  		...
  		for (var indFileDataProp in fileData) {
  			if (fileData.hasOwnProperty (indFileDataProp)) {
                ...
                if (metaData.coreRowType !== indFileData.rowType && indFileData.selected) {
                    ...
                    console.log ("unreconciled in ",indFileDataProp, unreconciled);
                }
  			}
  		}
	...
	this.parseFrag = function (theXML, fragQ, idAttrName, rowType) {
        console.log ("thexml", typeof theXML, theXML);
        ...
        for (var attrName in this.rowTypeDefaults) {
            if (this.rowTypeDefaults.hasOwnProperty (attrName)) {
                ...
                console.log ("att", attrName, "#", fileData[attrName], "#")
            }
        }
        console.log (ffrag.attr("fieldsEnclosedBy"));
		...
		console.log ("fieldsTerminatedBy", fileData.fieldsTerminatedBy);
    ...
    this.updateFilteredLists = function (fileData, presentFieldIndex) {
        ...
        console.log ("fi", fileData.fieldIndex, fileData.filteredFieldIndex, fileData.invFieldIndex, fileData.filteredInvFieldIndex);
    };
