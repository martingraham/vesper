L.TileLayer.MaskCanvas = L.TileLayer.Canvas.extend({
    ...
    _createTile: function () {
        ...
        g.globalCompositeOperation = 'src-over';
        return tile;
    },
    ...
    setData: function(dataset) {
        ...
        console.log ("bounds, ", this.bounds, this._boundsToQuery(this.bounds));
        this._quad = new QuadTree(this._boundsToQuery(this.bounds), true, 16, 10);
    ...
    _drawPoints: function (ctx, coordinates, bounds, thisRef) {
        var c = ctx.canvas,
            g = c.getContext('2d')
        ;
        ...
        g.lineWidth = 1;
        this._quad.drawInBounds (bounds, ctx, g, this);
    },

    _drawPointsOld: function (ctx, coordinates) {
        var c = ctx.canvas,
            g = c.getContext('2d'),
            self = this,
            p;
    ...
    _draw: function (ctx) {
        ...
        this._drawPoints(ctx, coordinates, bounds);
