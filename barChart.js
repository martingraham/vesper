...
VESPER.BarChart = function(divid) {
    ...
    function makeBins () {
        ...
        console.log ("bin stuff", binned.extremes, binned);
    }
	...
	this.update = function () {
        ...
        console.log ("SEL BINS", selBinned);
        ...
        var barDataTypes = ["unselected", "selected"];
        for (var k = 0; k < barDataSets.length; k++) {
            console.log ("bins", barDataSets[k]);
    ...
    this.redraw = function (currentDataSelection, barData) {
        ...
        console.log ("cds", currentDataSelection);
    ...
    this.chunkInfo = function (model, data, fields, /*binSize, binCount, round,*/ includeFunc) {
        ...
        //console.log ("fmm", min, max, hardMin, hardMax);
        var bins = [];
        ...
        findMinMax();
        //console.log ("Counted "+count+" properties.");
        ...
        if (min !== undefined && max !== undefined) {
            ...
            console.log ("MINS", maxd, mind, min, max, domRange, self.childScale.range());
            ...
            console.log ("bb", binSize, binCount);
    ...
    this.makeBarSizes = function (width, range) {
        ...
        console.log ("bdw: ", barDomainWidth, range, width);
