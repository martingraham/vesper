...
VESPER.Sanity = function(divid) {
	...
	this.update = function () {
        ...
        function popTable (rows, calcData, newCellOrder, cellFiller)  {
            ...
            console.log ("rows", rows, rows.enter());
        ...
        function fillCells (d, i) {
            ...
            if (cells.select("img").empty()) {
                cells.append("img").attr("class", "sanityBarFail").attr("src", "img/blackpixel.gif");
                cells.append("img").attr("class", "sanityBarOK").attr ("src", "img/whitepixel.gif");
                cells.selectAll("img")
                    .attr("height", 10)
                ;
            }
